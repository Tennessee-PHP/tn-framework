...
class OperationSet
{
     ...
     * @return array
     */
    public function setUserOperationsSinceLastSync(bool $fromClient = true): array
    {
        ...
        foreach ($operations as $operation) {
            $data = array_merge($data, $operation->getSyncDataForClient($map[$operation->model], $fromClient));
        }
