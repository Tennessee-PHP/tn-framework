<div class="{$classAttribute}" id="{$idAttribute}">
    <article class="my-5" id="typography">
        <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Typography</h3></div>
        <div>
            ...
            <div class="bd-example"><p class="lead"> This is a lead paragraph. It stands out from regular
                    paragraphs.</p></div>
            ...
            <div class="bd-example">
                <blockquote class="blockquote"><p>A well-known quote, contained in a blockquote element.</p>
    ...
    <article class="my-5" id="images">
        <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Images</h3></div>
        <div>
            <div class="bd-example">
            ...
            <div class="bd-example">
                <svg class="bd-placeholder-img img-thumbnail" width="200" height="200"
                     ...
                     preserveAspectRatio="xMidYMid slice" focusable="false"><title>A generic square placeholder
                        image with a white border around it, making it resemble a photograph taken with an old
                        instant camera</title>
                    <rect width="100%" height="100%" fill="#868e96"></rect>
                    <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#dee2e6" dy=".3em">
                        200×200
                    </text>
    ...
    <article class="my-5" id="tables">
        <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Tables</h3></div>
        <div>
            <div class="bd-example">
    ...
    <article class="my-5" id="figures">
        <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Figures</h3></div>
        <div>
            <div class="bd-example">
                <figure class="figure">
    ...
    <section id="forms"><h2 class="fw-bold pt-3 pt-xl-5 pb-2 pb-xl-3">Forms</h2>
        <article class="my-5" id="overview">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Overview</h3></div>
            <div>
                <div class="bd-example">
                    <form>
                        ...
                        <div class="mb-3 form-check form-switch"><input class="form-check-input" type="checkbox"
                                    ...
                                    class="form-check-label" for="flexSwitchCheckChecked">Checked switch checkbox
                                input</label></div>
                        <div class="mb-3"><label for="customRange3" class="form-label">Example range</label> <input
                                    type="range" class="form-range" min="0" max="5" step="0.5" id="customRange3"></div>
                        <button type="submit" class="btn btn-primary">Submit</button>
                    </form>
                </div>
            </div>
        </article>
        <article class="my-5" id="disabled-forms">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Disabled forms</h3></div>
            <div>
                <div class="bd-example">
                    <form>
                        <fieldset disabled="" aria-label="Disabled fieldset example">
                            ...
                            <div class="mb-3"><label for="disabledSelect" class="form-label">Disabled select
                                    menu</label> <select id="disabledSelect" class="form-select">
                                    <option>Disabled select</option>
                                </select></div>
                            <div class="mb-3">
                                <div class="form-check"><input class="form-check-input" type="checkbox"
                                                               id="disabledFieldsetCheck" disabled=""> <label
                                            class="form-check-label" for="disabledFieldsetCheck"> Can’t check
                                        this </label></div>
                            </div>
                            <fieldset class="mb-3">
                                <legend>Disabled radios buttons</legend>
                                <div class="form-check"><input type="radio" name="radios" class="form-check-input"
                                                               id="disabledRadio1" disabled=""> <label
                                            class="form-check-label" for="disabledRadio1">Disabled radio</label></div>
                                <div class="mb-3 form-check"><input type="radio" name="radios" class="form-check-input"
                                                                    id="disabledRadio2" disabled=""> <label
                                            class="form-check-label" for="disabledRadio2">Another radio</label></div>
                            </fieldset>
        ...
        <article class="my-5" id="sizing">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Sizing</h3></div>
            <div>
                <div class="bd-example">
        ...
        <article class="my-5" id="input-group">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Input group</h3></div>
            <div>
                <div class="bd-example">
        ...
        <article class="my-5" id="floating-labels">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Floating labels</h3></div>
            <div>
                <div class="bd-example">
                    <form>
        ...
        <article class="my-5" id="validation">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Validation</h3></div>
            <div>
                <div class="bd-example">
                    <form class="row g-3">
                        <div class="col-md-4"><label for="validationServer01" class="form-label">First name</label>
                            <input type="text" class="form-control is-valid" id="validationServer01" value="Mark"
                                   required="">
                            <div class="valid-feedback"> Looks good!</div>
                        </div>
                        <div class="col-md-4"><label for="validationServer02" class="form-label">Last name</label>
                        ...
                        <div class="col-12">
                            <div class="form-check"><input class="form-check-input is-invalid" type="checkbox" value=""
                                        ...
                                        class="form-check-label" for="invalidCheck3"> Agree to terms and
                                    conditions </label>
    ...
    <section id="components"><h2 class="fw-bold pt-3 pt-xl-5 pb-2 pb-xl-3">Components</h2>
        <article class="my-5" id="accordion">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Accordion</h3></div>
            <div>
                <div class="bd-example">
        ...
        <article class="my-5" id="alerts">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Alerts</h3></div>
            <div>
                <div class="bd-example">
                    <div class="alert alert-primary alert-dismissible fade show" role="alert"> A simple primary alert
                        with <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <div class="alert alert-secondary alert-dismissible fade show" role="alert"> A simple secondary
                        alert with <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <div class="alert alert-success alert-dismissible fade show" role="alert"> A simple success alert
                        with <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert"> A simple danger alert with
                        <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert"> A simple warning alert
                        with <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <div class="alert alert-info alert-dismissible fade show" role="alert"> A simple info alert with <a
                                href="#" class="alert-link">an example link</a>. Give it a click if you like.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <div class="alert alert-light alert-dismissible fade show" role="alert"> A simple light alert with
                        <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <div class="alert alert-dark alert-dismissible fade show" role="alert"> A simple dark alert with <a
                                href="#" class="alert-link">an example link</a>. Give it a click if you like.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                </div>
                <div class="bd-example">
                    <div class="alert alert-success" role="alert"><h4 class="alert-heading">Well done!</h4>
        ...
        <article class="my-5" id="badge">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Badge</h3></div>
            <div>
                <div class="bd-example"><p class="h1">Example heading <span class="badge bg-primary">New</span></p>
                    ...
                    <p class="h6">Example heading <span class="badge bg-dark">New</span></p></div>
                <div class="bd-example"><span class="badge rounded-pill bg-primary">Primary</span> <span
        ...
        <article class="my-5" id="breadcrumb">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Breadcrumb</h3></div>
            <div>
                <div class="bd-example">
        ...
        <article class="my-5" id="buttons">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Buttons</h3></div>
            <div>
                <div class="bd-example">
        ...
        <article class="my-5" id="button-group">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Button group</h3></div>
            <div>
                <div class="bd-example">
        ...
        <article class="my-5" id="card">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Card</h3></div>
            <div>
                <div class="bd-example">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body"><h5 class="card-title">Card title</h5>
                                    <p class="card-text">Some quick example text to build on the card title and make up
                                        the bulk of the card’s content.</p> <a href="#" class="btn btn-primary">Go
                                        somewhere</a></div>
                            </div>
                        </div>
                        <div class="col">
        ...
        <article class="my-5" id="carousel">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Carousel</h3></div>
            <div>
                <div class="bd-example">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item">
                                <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800"
                                    ...
                                    <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#555"
                                          dy=".3em">First slide
                                    </text>
                                </svg>
                            ...
                            <div class="carousel-item">
                                <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800"
                                    ...
                                    <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#444"
                                          dy=".3em">Second slide
                                    </text>
                                </svg>
        ...
        <article class="my-5" id="dropdowns">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Dropdowns</h3></div>
            <div>
                <div class="bd-example">
                    <div class="btn-group w-100 align-items-center justify-content-between flex-wrap">
                        <div class="dropdown">
                            <button class="btn btn-secondary btn-sm dropdown-toggle" type="button"
                                    id="dropdownMenuButtonSM" data-bs-toggle="dropdown" aria-expanded="false"> Dropdown
                                button
                            </button>
                        ...
                        <div class="dropdown">
                            <button class="btn btn-secondary btn-lg dropdown-toggle" type="button"
                                    id="dropdownMenuButtonLG" data-bs-toggle="dropdown" aria-expanded="false"> Dropdown
                                button
                            </button>
                    ...
                    <div class="btn-group">
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownRightMenuButton"
                                    data-bs-toggle="dropdown" aria-expanded="false"> End-aligned menu
                            </button>
        ...
        <article class="my-5" id="list-group">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>List group</h3></div>
            <div>
                <div class="bd-example">
                    <ul class="list-group">
                ...
                <div class="bd-example">
                    <div class="list-group"><a href="#" class="list-group-item list-group-item-action">A simple default
                            list group item</a> <a href="#"
        ...
        <article class="my-5" id="modal">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Modal</h3></div>
            <div>
                <div class="bd-example">
                    <div class="d-flex justify-content-between flex-wrap">
                        ...
                        <div class="modal fade" id="staticBackdropLive" data-bs-backdrop="static"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header"><h5 class="modal-title" id="staticBackdropLiveLabel">Modal
                                            title</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body"><p>I will not close if you click outside me. Don’t even try
                                            to press escape key.</p></div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close
                                        </button>
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#exampleModalCenteredScrollable"> Vertically centered scrollable modal
                        </button>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body"><p>This is some placeholder content to show the scrolling
                                            behavior for modals. We use repeated line breaks to demonstrate how content
                                            can exceed minimum inner height, thereby showing inner scrolling. When
                                            content becomes longer than the prefedined max-height of modal, content will
                                            be cropped and scrollable within the modal.</p> <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                            ...
                            <div class="modal-dialog modal-fullscreen">
                                <div class="modal-content">
                                    <div class="modal-header"><h5 class="modal-title h4"
                                                                  id="exampleModalFullscreenLabel">Full screen
                                            modal</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
        ...
        <article class="my-5" id="navs">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Navs</h3></div>
            <div>
                <div class="bd-example">
                    <nav class="nav"><a class="nav-link active" aria-current="page" href="#">Active</a> <a
                                class="nav-link" href="#">Link</a> <a class="nav-link" href="#">Link</a> <a
                                class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Disabled</a></nav>
                </div>
                <div class="bd-example">
                    <nav>
                        <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false" tabindex="-1">Profile
                            </button>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <p><strong>This is some placeholder content the Profile tab’s associated content.</strong>
                                ...
                                with tabs, pills, and any other <code>.nav</code>-powered navigation.</p></div>
        ...
        <article class="my-5" id="offcanvas">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Offcanvas</h3></div>
            <a class="btn btn-primary" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button"
               aria-controls="offcanvasExample">Offcanvas</a>
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                 aria-labelledby="offcanvasExampleLabel">
                <div class="offcanvas-header"><h5 class="offcanvas-title" id="offcanvasExampleLabel">Offcanvas</h5>
            ...
            <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop"
                    aria-controls="offcanvasTop">Top offcanvas
            </button>
            <div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
                <div class="offcanvas-header"><h5 class="offcanvas-title" id="offcanvasTopLabel">Offcanvas top</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
                <div class="offcanvas-body"> …</div>
            </div>
            <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
                    aria-controls="offcanvasRight">Right offcanvas
            </button>
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                 aria-labelledby="offcanvasRightLabel">
                <div class="offcanvas-header"><h5 class="offcanvas-title" id="offcanvasRightLabel">Offcanvas right</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
                <div class="offcanvas-body"> …</div>
            </div>
            <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom"
                    aria-controls="offcanvasBottom">Bottom offcanvas
            </button>
            <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom"
                 aria-labelledby="offcanvasBottomLabel">
                <div class="offcanvas-header"><h5 class="offcanvas-title" id="offcanvasBottomLabel">Offcanvas
                        bottom</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
        ...
        <article class="my-5" id="pagination">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Pagination</h3></div>
            <div>
                <div class="bd-example">
        ...
        <article class="my-5" id="popovers">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Popovers</h3></div>
            <div>
                <div class="bd-example">
        ...
        <article class="my-5" id="progress">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Progress</h3></div>
            <div>
                <div class="bd-example">
        ...
        <article class="my-5" id="scrollspy">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Scrollspy</h3></div>
            <div>
                <div class="bd-example">
                    <nav id="navbar-example2" class="navbar px-3"><a class="navbar-brand"
                                                                     href="#">Navbar</a>
                        <ul class="nav nav-pills">
                    ...
                    <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"
                         class="scrollspy-example" tabindex="0"><h4 id="scrollspyHeading1">First heading</h4>
        ...
        <article class="my-5" id="spinners">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Spinners</h3></div>
            <div>
                <div class="bd-example">
        ...
        <article class="my-5" id="toasts">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Toasts</h3></div>
            <div>
                <div class="bd-example bg-dark p-5 align-items-center">
                    <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                        <div class="toast-header">
                            ...
                            <strong class="me-auto">Bootstrap</strong> <small class="text-muted">11 mins ago</small>
        ...
        <article class="mt-3 mb-5 pb-5" id="tooltips">
            <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2"><h3>Tooltips</h3></div>
            <div>
