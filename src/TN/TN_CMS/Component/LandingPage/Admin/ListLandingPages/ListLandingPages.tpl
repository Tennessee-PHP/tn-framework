            ...
            <table class="table">
                ...
                {foreach $landingPages as $landingPage}
                    <tr data-landingpageid="{$landingPage->id}" data-landingpagetitle="{$landingPage->title}">
                        ...
                        <td>{if $landingPage->contentRequired}{$landingPage->contentRequired} {elseif !$landingPage->contentRequired}
                                free{/if}
                        </td>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger delete-confirm" data-bs-dismiss="modal">Yes, Delete</button>
                    </div>
                </div>
            </div>
        </div>
